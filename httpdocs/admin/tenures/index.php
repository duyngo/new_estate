<?php include "../../../controller/admin/tenures/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Tenure List</title>
<meta charset="utf-8">
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="name" value="<?php echo $_SESSION['tenures']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="code" value="<?php echo $_SESSION['tenures']['code'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
	...
	<section id="resultBox">
		...
		<table id="resultTbl" class="resultTbl sortable">
			<tr>
				...
				<th class="unsortable">created_by</th>
				<th class="unsortable">modified</th>
				<th class="unsortable">modified_by</th>
...
?>
			<tr>
				...
				<td><?php echo common_get_value("users","name",$arr['created_by'],"");?>
</td>
