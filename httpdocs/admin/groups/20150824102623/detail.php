<?php
 include "/home/" . $_SERVER['SERVER_NAME'] . "/controller/admin/groups/detail.php";
?>
<!DOCTYPE html>
<html>
<head>
...
<p class="link"><a href="/admin/locations/edit.php?groups_id=<?php echo $_REQUEST['id'];?>&tab=locations">Location Add</a></p>
</div>
<!-- (( comp-table -->
<div id="comp-table">
...
<?php
$result = groups_locations_index( $_REQUEST['id'] );
?>
...
<p class="link"><a href="/admin/amenities/edit.php?groups_id=<?php echo $_REQUEST['id'];?>&tab=amenities">Amenity Add</a></p>
</div>
<!-- (( comp-table -->
<div id="comp-table">
<section id="resultBox">
...
<?php
$result = groups_amenities_index( $_REQUEST['id'] );
?>
<p class="resultNum">SearchResult：<span><?php echo mysql_num_rows( $result );?></span>件</p>
<!--p class="registBtn"><input value="Add" id="submit" type="submit"></p-->
<div class="pager">
...
<td class="aC"><a href="/admin/amenities/edit.php?id=<?php echo $arr['id'];?>&tab=amenities">edit</a></td>
				...
				<td><?php echo $arr['map_coordinates'];?></td>
...
<p class="link"><a href="/admin/listings/edit.php?groups_id=<?php echo $_REQUEST['id'];?>&tab=listings">Listing Add</a></p>
</div>
<!-- (( comp-table -->
<div id="comp-table">
<section id="resultBox">
...
<?php
$result = groups_listings_index( $_REQUEST['id'] );
?>
<p class="resultNum">SearchResult：<span><?php echo mysql_num_rows( $result );?></span>件</p>
<!--p class="registBtn"><input value="Add" id="submit" type="submit"></p-->
<div class="pager">
