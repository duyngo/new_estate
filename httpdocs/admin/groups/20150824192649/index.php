<?php include "/home/newpropertylist.my/controller/admin/groups/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Area Group List</title>
<meta charset="utf-8">
...
?>
				<option value="<?php echo $arr['id'];?>" <?php if( $arr['id'] == $_SESSION['groups']['states_id'] ){ echo "selected"; } ?>><?php echo $arr['name'];?></option>
<?php
}
?>
				</select>
				...
				<td>
				<input name="name" value="<?php echo $_SESSION['groups']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
