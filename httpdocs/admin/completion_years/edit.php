<?php include "/home/newpropertylist.my/controller/admin/completion_years/edit.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Completion year Add/Edit</title>
<meta charset="utf-8">
...
?>
		<table>
			<tr id="name">
				<th>Name</th>
				<td class="<?php if(completion_years_err_check("name")){ echo "errorInput"; }?> must">
					<input name="name" size="64" id="name" class="TextInput" type="text" title="name" value="<?php echo $_POST['name'];?>">
				</td>
			</tr>
			<tr id="code">
				<th>Code(Url)</th>
				<td class="<?php if(completion_years_err_check("code")){ echo "errorInput"; }?> must">
					<input name="code" size="32" id="code" class="TextInput" type="text" title="code" value="<?php echo $_POST['code'];?>">
				</td>
			</tr>
			<tr id="sort">
				<th>sort</th>
				<td class="<?php if(completion_years_err_check("sort")){ echo "errorInput"; }?> must">
