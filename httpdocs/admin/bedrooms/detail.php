<?php
 include "/home/" . $_SERVER['SERVER_NAME'] . "/controller/admin/bedrooms/detail.php";
?>
<!DOCTYPE html>
<html>
<head>
...
<p class="link"><a href="/admin/listings/edit.php?bedrooms_id=<?php echo $_REQUEST['id'];?>&tab=listings">Listing Add</a></p>
</div>
<!-- (( comp-table -->
<div id="comp-table">
...
<?php
$result = bedrooms_listings_index( $_REQUEST['id'] );
?>
