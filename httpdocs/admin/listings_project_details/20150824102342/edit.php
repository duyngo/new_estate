<?php include "/home/newpropertylist.my/controller/admin/listings_project_details/edit.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Listings project details Add/Edit</title>
<meta charset="utf-8">
...
?>
	<section id="editForm">
		<h2>Listings project details Add/Edit</h2>
...
?>
			...
			<tr id="head">
				<th>Head</th>
				<td class="<?php if(listings_project_details_err_check("head")){ echo "errorInput"; }?> must">
					<input name="head" size="128" id="head" class="TextInput" type="text" title="head" value="<?php echo $_POST['head'];?>">
				</td>
			</tr>
			<tr id="body">
				<th>Body</th>
				<td class="<?php if(listings_project_details_err_check("body")){ echo "errorInput"; }?> must">
...
?>
	<section id="editForm">
		<h2>Listings project detailsAdd/Edit</h2>
		<table>
			<tr>
				<th>Listings</th>
