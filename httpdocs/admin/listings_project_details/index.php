<?php include "../../../controller/admin/listings_project_details/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>project details List</title>
<meta charset="utf-8">
...
?>
				...
				<td>
				<input name="sub_head" value="<?php echo $_SESSION['listings_project_details']['sub_head'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
	...
	<section id="resultBox">
		...
		<table id="resultTbl" class="resultTbl sortable">
			<tr>
				...
				<th class="unsortable">Sub_Head</th>
...
?>
			<tr>
				...
				<td><?php echo $arr['sub_head'];?></td>
				<td><?php echo str_replace("\n","<br />",$arr['body']);?></td>
				<td><?php if(!empty($arr['image_path'])){ ?><img src="/admin/images/listings_project_details/<?php echo $arr['image_path'];?>" width="<?php echo admin_common_get_image_width("listings_project_details",$arr['image_path']);?>" height="auto"><?php } ?></td>
