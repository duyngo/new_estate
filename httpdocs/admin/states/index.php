<?php include "../../../controller/admin/states/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="name" value="<?php echo $_SESSION['states']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
	...
	<section id="resultBox">
		...
		<table id="resultTbl" class="resultTbl sortable">
			<tr>
				...
				<th class="unsortable">code(URL用)</th>
...
?>
			<tr>
				...
				<td><?php if(!empty($arr['image_path'])){ ?><img src="/admin/images/states/<?php echo $arr['image_path'];?>" width="<?php echo admin_common_get_image_width("states",$arr['image_path']);?>" height="auto"><?php } ?></td>
				<td><?php echo str_replace("\n","<br />",$arr['description']);?></td>
				<td><?php echo $arr['sort'];?></td>
				<td class="delete"><a href="./index.php?act=delete&id=<?php echo $arr['id'];?>&image_path=<?php echo $arr['image_path'];?>" onclick="return delete_check();">delete</a></td>
			</tr>
<?php
	}
}
