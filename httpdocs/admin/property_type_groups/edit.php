<?php include "../../../controller/admin/property_type_groups/edit.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Property Type Group Add/Edit</title>
<meta charset="utf-8">
...
?>
		<table>
			<tr id="name">
				<th>Name</th>
				<td class="<?php if(property_type_groups_err_check("name")){ echo "errorInput"; }?> must">
					<input name="name" size="64" id="name" class="TextInput" type="text" title="name" value="<?php echo $_POST['name'];?>">
				</td>
			</tr>
			<tr id="code">
				<th>code</th>
				<td class="<?php if(property_type_groups_err_check("code")){ echo "errorInput"; }?> must">
					<input name="code" size="32" id="code" class="TextInput" type="text" title="code" value="<?php echo $_POST['code'];?>">
				</td>
			</tr>
			<tr id="image_path">
				<th>Image</th>
				<td class="<?php if(property_type_groups_err_check("image_path")){ echo "errorInput"; }?>">
<?php if(!empty($_SESSION['property_type_groups']['image_path'])){ ?>
				<div>
					<div><img src="/admin/images/property_type_groups/<?php echo $_SESSION['property_type_groups']['image_path'];?>" width="100"></div>
					<div><input type="checkbox" name="image_path" value="delete">delete this image</div>
				</div>
<?php } ?>
				<input type="file" name="image_path" />
<p class="note">※※width:740 * height:354 size required</p>				</td>
			</tr>
			<tr id="description">
				<th>Description at search result page</th>
				<td class="<?php if(property_type_groups_err_check("description")){ echo "errorInput"; }?>">
					<textarea name="description" title="" rows="5" cols="50" id="description" ><?php echo $_POST['description'];?></textarea>
				</td>
			</tr>
			<tr id="sort">
				<th>Sort</th>
				<td class="<?php if(property_type_groups_err_check("sort")){ echo "errorInput"; }?> must">
...
?>
	<section id="editForm">
		<h2>Property Type GroupAdd/Edit</h2>
		<table>
			<tr>
				<th>Name</th>
			...
			<tr>
				<th>Image</th>
				<td><?php if(!empty($_SESSION['property_type_groups']['image_path'])){ ?> <img src="/admin/images/property_type_groups/<?php echo $_SESSION['property_type_groups']['image_path'];?>" width="100"> <?php } ?>
</td>
			</tr>
			<tr>
				<th>Description at search result page</th>
