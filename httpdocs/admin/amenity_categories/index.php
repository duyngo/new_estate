<?php include "../../../controller/admin/amenity_categories/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Amenity Category List</title>
<meta charset="utf-8">
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="name" value="<?php echo $_SESSION['amenity_categories']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
	...
	<section id="resultBox">
		...
		<table id="resultTbl" class="resultTbl sortable">
			<tr>
				...
				<th class="unsortable">Category name</th>
				<th class="unsortable">Code</th>
				<th class="unsortable">image_path</th>
				<th class="unsortable">icon</th>
				<th class="unsortable">Hit radius</th>
...
?>
			<tr>
				...
				<td><?php if(!empty($arr['image_path'])){ ?><img src="/admin/images/amenity_categories/<?php echo $arr['image_path'];?>" width="<?php echo admin_common_get_image_width("amenity_categories",$arr['image_path']);?>" height="auto"><?php } ?></td>
				<td><?php if(!empty($arr['icon'])){ ?><img src="/admin/images/amenity_categories/<?php echo $arr['icon'];?>" width="<?php echo admin_common_get_image_width("amenity_categories",$arr['icon']);?>" height="auto"><?php } ?></td>
				<td><?php echo $arr['hit_radius'];?></td>
