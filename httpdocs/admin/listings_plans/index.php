<?php include "/home/newpropertylist.my/controller/admin/listings_plans/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="listings_id" value="<?php echo $_SESSION['listings_plans']['listings_id'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="name" value="<?php echo $_SESSION['listings_plans']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
...
?>
				<option value="<?php echo $key;?>" <?php if( $key == $_SESSION['listings_plans']['display_flag'] ){ echo "selected"; } ?>><?php echo $val;?></option>
<?php
}
?>
				</select>
