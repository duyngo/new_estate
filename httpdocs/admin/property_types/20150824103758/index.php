<?php include "/home/newpropertylist.my/controller/admin/property_types/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Property type List</title>
<meta charset="utf-8">
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="name" value="<?php echo $_SESSION['property_types']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="description" value="<?php echo $_SESSION['property_types']['description'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
