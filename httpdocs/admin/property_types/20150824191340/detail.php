<?php
 include "/home/" . $_SERVER['SERVER_NAME'] . "/controller/admin/property_types/detail.php";
?>
<!DOCTYPE html>
<html>
<head>
...
<p class="link"><a href="/admin/listings/edit.php?property_types_id=<?php echo $_REQUEST['id'];?>&tab=listings">Listing Add</a></p>
</div>
<!-- (( comp-table -->
<div id="comp-table">
...
<?php
$result = property_types_listings_index( $_REQUEST['id'] );
?>
