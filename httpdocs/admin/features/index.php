<?php include "/home/newpropertylist.my/controller/admin/features/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="id" value="<?php echo $_SESSION['features']['id'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="name" value="<?php echo $_SESSION['features']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="code" value="<?php echo $_SESSION['features']['code'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
	...
	<section id="resultBox">
		...
		<table id="resultTbl" class="resultTbl sortable">
			<tr>
				...
				<th class="unsortable">code(Used as part of URL)</th>
...
?>
			<tr>
				...
				<td><?php if(!empty($arr['image_path'])){ ?><img src="/admin/images/features/<?php echo $arr['image_path'];?>" width="100" height="auto"><?php } ?></td>
