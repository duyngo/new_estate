<?php include "../../../controller/admin/listings_photos/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="listings_id" value="<?php echo $_SESSION['listings_photos']['listings_id'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
...
?>
			<tr>
				...
				<td><?php if(!empty($arr['image_path'])){ ?><img src="/admin/images/listings_photos/<?php echo $arr['image_path'];?>" width="<?php echo admin_common_get_image_width("listings_photos",$arr['image_path']);?>" height="auto"><?php } ?></td>
				<td><?php echo $arr['caption'];?></td>
