<?php include "../../../controller/admin/listings_call_clicks/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Listing Call Click Log List</title>
<meta charset="utf-8">
...
<article id="contBox">
	<h2>Listing Call Click Log List</h2>
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="listings_id" value="<?php echo $_SESSION['listings_call_clicks']['listings_id'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
	...
	<section id="resultBox">
		...
		<table id="resultTbl" class="resultTbl sortable">
			<tr>
				...
				<th class="unsortable">Listings id</th>
				<th class="unsortable">Members id</th>
...
?>
			<tr>
				...
				<td><?php echo common_get_value("members","name",$arr['members_id'],"");?>
</td>
