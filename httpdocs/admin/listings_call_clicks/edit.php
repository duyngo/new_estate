<?php include "../../../controller/admin/listings_call_clicks/edit.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Listing Call Click Log Add/Edit</title>
<meta charset="utf-8">
...
?>
	<section id="editForm">
		<h2>Listing Call Click Log Add/Edit</h2>
		<form id="Login" name="Login" action="<?php echo $_SERVER['SCRIPT_NAME'];?>" method="post" ENCTYPE="multipart/form-data">
<?php
if( $_POST['act'] == "err" ){
?>
	<ul class="errorTxt"><?php echo listings_call_clicks_err_check(NULL); ?></ul>
<?php
}
?>
		<table>
...
?>
	<section id="editForm">
		<h2>Listing Call Click LogAdd/Edit</h2>
		<table>
		</table>
		<table width="50%">
		<tr>
