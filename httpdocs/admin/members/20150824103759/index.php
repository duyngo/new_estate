<?php include "/home/newpropertylist.my/controller/admin/members/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="name" value="<?php echo $_SESSION['members']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="email" value="<?php echo $_SESSION['members']['email'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="phone" value="<?php echo $_SESSION['members']['phone'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
	...
	<section id="resultBox">
		...
		<table id="resultTbl" class="resultTbl sortable">
			<tr>
				...
				<th class="unsortable">JoinDate</th>
...
?>
			<tr>
				...
				<td><?php echo $members_nationality_list[$arr['nationality']];?></td>
