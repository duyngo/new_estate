<?php include "/home/newpropertylist.my/controller/admin/countries/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="code" value="<?php echo $_SESSION['countries']['code'];?>" size="50" id="name1" class="TextInput" type="text">
				</td>
				<td>
				<input name="name" value="<?php echo $_SESSION['countries']['name'];?>" size="50" id="name1" class="TextInput" type="text">
				</td>
				<td>
				<input name="logical_name" value="<?php echo $_SESSION['countries']['logical_name'];?>" size="50" id="name1" class="TextInput" type="text">
				</td>
			</tr>
			</table>
