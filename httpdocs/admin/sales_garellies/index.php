<?php include "../../../controller/admin/sales_garellies/index.php"; ?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Sales Gallery List</title>
<meta charset="utf-8">
...
<article id="contBox">
	...
	<section id="searchBox">
		...
		<div class="toggle_search">
			...
			<tr>
				<td>
				<input name="companies_id" value="<?php echo $_SESSION['sales_garellies']['companies_id'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
				<td>
				<input name="name" value="<?php echo $_SESSION['sales_garellies']['name'];?>" size="20" id="name1" class="TextInput" type="text" title="">
				</td>
			</tr>
			</table>
