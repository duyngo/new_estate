...
?>
				<option value="<?php echo $arr['id'];?>" <?php if( $arr['id'] == $_POST['companies_id'] ){ echo "selected"; } ?>><?php echo $arr['name'];?></option>
<?php
}
?>
				</select>
...
<p class="note">※Enter name as per passport/IC in roman alphabets (A-Z) only</p>				</td>
			</tr>
			<tr id="last_name">
				<th>Last name</th>
