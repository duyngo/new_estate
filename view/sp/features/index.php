...
<html lang="en">
  <head>
    ...
    <title>Find your new property for sale by Features | NewPropertyList.my</title>
    <meta name="keywords" content="NewPropertyList.my, new property for sale, Find by Features"/>
    <meta name="description" content="Are you looking for new house in Malaysia? You can find new property for Sale by Features - NewPropertyList.my"/>
    <link rel="canonical" href="http://newpropertylist.my/features/">
...
?>
        <div class="mdFTR01Items">
          <div class="mdFTR01Img"><a href="/features/<?php echo $arr['code'];?>"><img src="/admin/images/features/<?php echo $arr['image_path'];?>" alt="<?php echo $arr['name'];?>"></a></div>
          <div class="mdFTR01Txt">
            <h2 class="Gold h2"><?php echo $arr['name'];?></h2>
            <p class="p"><?php echo str_replace("\n","</p><p>",$arr['description']);?></p>
          </div>
        </div><!--mdFTR01Items-->
<?php
}
