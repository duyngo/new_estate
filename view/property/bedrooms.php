...
while( $arr = mysql_fetch_array( $result )){
        ...
        if( $arr['code'] != $bedrooms_code ){   //change bedrooms_code
                ...
                if(!empty($tenures_code)){
                        if(!empty($locations_code)||!empty($groups_code)||!empty($property_type_groups_code)||!empty($prices_code)||!empty($prices_code)||!empty($sizes_code)||!empty($completion_years_code)){
                                $url .= "_";
                        }
                        $url .= $tenures_code;
                }
