...
<?php
$i=0;
include $_SERVER['BASE_DIR'] . "/view/property/states.php";
include $_SERVER['BASE_DIR'] . "/view/property/groups.php";
include $_SERVER['BASE_DIR'] . "/view/property/locations.php";
include $_SERVER['BASE_DIR'] . "/view/property/property_type_groups.php";
include $_SERVER['BASE_DIR'] . "/view/property/prices.php";
include $_SERVER['BASE_DIR'] . "/view/property/tenures.php";
include $_SERVER['BASE_DIR'] . "/view/property/completion_years.php";
include $_SERVER['BASE_DIR'] . "/view/property/bedrooms.php";
include $_SERVER['BASE_DIR'] . "/view/property/sizes.php";
?>
        ...
        <div class="LyMain">
          <div class="MdSAC01MainContents">
            ...
            <div class="MdSAC01Box01">
              <img alt="" src="<?php echo $image;?>" />
              <h1 class="mdSAC01Txt01"><?php echo $h1;?></h1>
<?php
if( $row_num_pager <= 15 ){
?>
              <div class="mdSAC01Btn01">
                <a href="/enquiry/once_for_all">Enquiry once for all</a>
              </div>
              <div class="mdSAC01Txt02">
                <span>You can enquiry once for all listings below</span>
              </div>
<?php
}
?>
              <div class="MdSAC01LinkBox01">
                <a href="/about/">What’s NewPropertyList.my?</a>
              </div>
            </div>
...
<?php
$column_arr = array("states","groups","locations","property_type_groups","prices","sizes","bedrooms","completion_years","tenures");
foreach( $column_arr as $column ){
	$url = NULL;
	$code = $column . "_code";
	$name = $column . "_name";
	if( !empty( $$code ) && !( $column == "states" && $states_code == "all-state" )){
		$url = listings_get_url( $column,$states_code,$groups_code,$locations_code,$property_type_groups_code,$prices_code,$sizes_code,$bedrooms_code,$completion_years_code,$tenures_code );
?>
      ...
      <!--div class="MdSAC06SendEnquiry">
        <div class="MdSAC06InnerBox01">
          <div class="mdSAC06Txt01">
            <span><div class="cart_footer"><?php echo $fav_num;?></div></span>
          </div>
