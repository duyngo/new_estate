...
<?php
$i=0;
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/states.php";
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/groups.php";
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/locations.php";
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/property_type_groups.php";
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/prices.php";
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/completion_years.php";
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/bedrooms.php";
include $_SERVER['BASE_DIR'] . "/view/real-estate-developers/sizes.php";
?>
          ...
          <div class="MdSAC01MainContents">
            <div class="MdFTR02SearchCellBox">
              <div class="MdFTR02ChildImgCell">
                <img alt="" src="/admin/images/companies/<?php echo $developer_logo_image_path;?>" />
              </div>
